...
export default function Home() {
  ...
  return (
    <div className="flex h-screen w-screen bg-gradient-to-r from-slate-950 to-slate-900">
      <SideMenu/>
      <div className="relative rounded-xl overflow-hidden w-5/20 h-8/10 top-22 left-1 scale-90 transition-all duration-300 hover:scale-100">
        <Image
          src="/portfolio.jpg"
      ...
      <div className="flex flex-col justify-center items-start w-1/2 text-white p-16">
        <h1 className="text-8xl font-bold mb-10"> Gabriel Santos </h1>
        <p className="text-2xl mb-10 ml-1">
          {" "}
        ...
        <div className="flex space-x-6 ml-2">
          ...
          >
            <FaLinkedin size={50} color="00063D" />
          </a>
          <a
            href="#"
            className="hover:opacity-100 bg-gradient-to-r from-cyan-500 to-cyan-400 scale-110 transition-all duration-300 hover:scale-130"
          >
            <FaSquareGithub size={50} color="00063D" />
          </a>
        </div>
      </div>
    </div>
